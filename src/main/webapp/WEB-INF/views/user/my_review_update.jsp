...
<body>
	<div id="wrap">
		...
		<section>
			<!-- 20200731 사용 -->
			<form action="my_review_update_ok" method="post" enctype="multipart/form-data">
				<input type="hidden" name="idx" value="${review.idx }"> <input type="hidden" id="w_grade" name="w_grade" value="${review.w_grade }">
				<table width="960px">
					<tr>
						<td>상품명</td>
					...
					<tr>
						<td>내용</td>
						<td><textarea name="w_content" rows="15" cols="50" placeholder="${review.w_content }">${review.w_content }</textarea></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
